...
bool Video::loadSetting(int mode) {
    ...
    else if (VideoType::USB == videoMode) {
        printf("VideoType::USB, loadSetting fail!\n");
        return true;
    }
    else if (VideoType::MP4 == videoMode) {
        printf("VideoType::MP4, loadSetting fail!\n");
        return true;
    }
}

bool Video::setVideoMode(int mode) {
    videoMode = mode;
    return true;
}

bool Video::setMP4Location(string loc) {
    mp4Location = loc;
    return true;
}
...
bool Video::videoCheck() {
    ...
    if (VideoType::DAHUA == videoMode) {
        ...
        printf("VideoType::USB, nothing to check!\n");
        return true;
    }
    else if (VideoType::MP4 == videoMode) {
        printf("VideoType::MP4, nothing to check!\n");
        return true;
    }
...
void Video::videoClose() {
    ...
    if (VideoType::DAHUA == videoMode) {
        ...
        printf("disconnect camera success.\n");
    }
    else if (VideoType::USB == videoMode) {
        cap.release();
        printf("disconnect usb-camera success.\n");
        
    }
    else if (VideoType::MP4 == videoMode) {
        cap.release();
        printf("disconnect mp4-video success.\n");
    }
}
...
bool Video::videoStart() {
    ...
    if (VideoType::DAHUA == videoMode) {
        ...
        printf("VideoType::USB, nothing to start!\n");
    }
    else if (VideoType::MP4 == videoMode) {
        printf("VideoType::MP4, nothing to start!\n");
    }
    return true;
}
...
void Video::startGrabbing() {
    ...
    if (VideoType::DAHUA == videoMode) {
        ...
        printf("VideoType::USB, nothing to startGrabbing!\n");
    }
    else if (VideoType::MP4 == videoMode) {
        printf("VideoType::MP4, nothing to startGrabbing!\n");
    }
}
...
void Video::CameraChangeTrig(ETrigType trigType) {
    ...
    if (VideoType::DAHUA == videoMode) {
        ...
        printf("VideoType::USB, nothing to do CameraChangeTrig!\n");
    }
    else if (VideoType::MP4 == videoMode) {
        printf("VideoType::MP4, nothing to do CameraChangeTrig!\n");
    }
}
